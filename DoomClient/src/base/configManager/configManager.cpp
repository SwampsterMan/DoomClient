...
{
	std::string path = configmanager::GetDoomClientPath() + "/configs/";
...
std::string configmanager::GetDoomClientPath()
{
	std::string path = configmanager::GetDocumentsPath() + "/DoomClient/";
...
{
	std::string filePath = configmanager::GetDoomClientPath() + "friends.json";
...
bool configmanager::SaveFriends()
{
	...
	std::string dirPath = configmanager::GetDoomClientPath();
