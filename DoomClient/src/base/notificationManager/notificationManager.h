...
#define NotificationInfo(message, ...) NotificationManager::Send("DoomClient :: Info", message, ##__VA_ARGS__)
#define NotificationWarning(message, ...) NotificationManager::Send("DoomClient :: Warning", message, ##__VA_ARGS__)
#define NotificationError(message, ...) NotificationManager::Send("DoomClient :: Error", message, ##__VA_ARGS__)