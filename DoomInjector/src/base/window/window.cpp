...
void Window::Init() {
    ...
    WNDCLASSEXW wc = { sizeof(wc), CS_CLASSDC, Window::WndProc, 0L, 0L, GetModuleHandle(nullptr), LoadIconW(GetModuleHandle(nullptr), MAKEINTRESOURCE(IDI_ICON1)), LoadCursor(nullptr, IDC_ARROW), nullptr, nullptr, L"Doom Injector", LoadIconW(GetModuleHandle(nullptr), MAKEINTRESOURCE(IDI_ICON1)) };
    ...
    ::RegisterClassExW(&wc);
    hwnd = ::CreateWindowW(wc.lpszClassName, L"Doom Injector", WS_OVERLAPPEDWINDOW & ~WS_SIZEBOX, (screenWidth / 2) - (WINDOW_WIDTH / 2), (screenHeight / 2) - (WINDOW_HEIGHT / 2), WINDOW_WIDTH, WINDOW_HEIGHT, nullptr, nullptr, wc.hInstance, nullptr);
